...
//			"4.4-SNAPSHOT", "649", "Enterprise");
	...
	public JiraClient client() throws Exception {
		return client(org.eclipse.mylyn.tests.util.TestUtil.PrivilegeLevel.USER);
	}

	public JiraClient client(org.eclipse.mylyn.tests.util.TestUtil.PrivilegeLevel level) throws Exception {
